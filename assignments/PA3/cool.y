  ...
  #define cool_yylloc curr_lineno  /* use the curr_lineno from the lexer for the location of tokens */
    ...
    * would look like the following:
    ...
    plus_consts	: INT_CONST '+' INT_CONST 
    {
      ...
      // Observe that we call SET_NODELOC(@1); this will set the global variable
    ...
    */
    ...
    %type <expressions> expr_list expr_list_semicolon
    %type <expression> expr expr_block let_body
    ...
    */
    ...
    /*Expression list for method call*/
    expr_list:
    { $$ = nil_Expressions(); }
    | expr_list ',' expr
    ...
    /*Expression list for a block of code*/
    expr_list_semicolon:
    expr ';' { $$ = single_Expressions($1); }
    | expr_list_semicolon expr ';' { $$ = append_Expressions($1, single_Expressions($2)); }
    ;

    expr_block:
      '{' expr_list_semicolon '}' { SET_NODELOC(@1); $$ = block($2); }
    ;
